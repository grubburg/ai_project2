...
player package/class specifications (positional arguments):
  ...
  your top-level package (i.e. 'electric_sheep').
  ...
  with import statements, e.g. 'electric_sheep.player2') or relative path (to a
  file or directory containing the Python module, e.g. 'electric_sheep/player3'
  or 'electric_sheep/players/player4.py').
  ...
  (e.g. 'electric_sheep:DifferentPlayer').
